...
class GetQueryEmptyCanonicalRequestTest {
    @Test
    fun `canonical request should work with empty query parameters`() {
        val request = request {
            url = "https://api.babbel-staging.io/gamma/v1.1.0/en/accounts/6874a00f78d738e0204277ff665df284/learn_languages/SPA/trainer_items/?since=&sort=last_reviewed_at&limit=2147483647"
        ...
        Assertions.assertThat(result).isEqualTo(ResourceHelper.readResource("get-query-empty.creq"))
    }
}